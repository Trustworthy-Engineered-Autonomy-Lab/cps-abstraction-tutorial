...
from cegar.abstraction import Rect, RectPartition, TransitionRelation, Abstraction


class StepDynamics:
    """Provides the interface that the validator expects."""
...
class KrishAbstraction:
    ...
    def rebuild_all_transitions(self) -> None:
        from cegar.helpers.partitioning_generalized import (
