...
from cegar.helpers.systems.synthetic import SyntheticSystem

from utils.model_checking_tools import (
...
def main():
    ...
    parser.add_argument("--system", type=str, default="cegar.helpers.systems.synthetic",
