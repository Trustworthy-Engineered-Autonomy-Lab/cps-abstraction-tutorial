...
# Allow running as a script: `python src/selfloop/abstract_unicycle_with_self_loop_removal.py`
...
from utils.model_checking_tools import UnicycleModelChecker
...
from systems.unicycle import UnicycleSystem
from utils.self_loop_uni import *
...
if __name__ == '__main__':
    ...
    run_root = Path('runs') / 'selfloop' / 'unicycle'
    ...
    if kripke_stats_results:
        ...
        logger.warn('Skipping rollup metrics (Kripke stats not available).')
